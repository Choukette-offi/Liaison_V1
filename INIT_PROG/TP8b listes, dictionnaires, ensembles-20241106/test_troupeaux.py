...
def test_total_animaux():
    ...
    assert troupeaux.total_animaux(mon_troupeau) == 80
...
def test_tous_les_animaux():
    ...
    assert troupeaux.tous_les_animaux(mon_troupeau) == {'vache', 'cochon', 'mouton', 'chat'}
...
def test_reunion_troupeaux():
    ...
    assert troupeaux.reunion_troupeaux(troupeau_de_perrette, mon_troupeau) == {'veau':14, 'vache':41, 'poule':42, 'cochon':5, 'mouton':40, 'chat':1 }
    assert troupeaux.reunion_troupeaux(mon_troupeau, troupeau_de_jean) == {'vache':46, 'cochon':22, 'mouton':40, 'chat':1, 'veau':3}
    assert troupeau_de_jean == {'vache':12, 'cochon':17, 'veau':3}
    assert troupeau_de_perrette == {'veau':14, 'vache':7, 'poule':42}
